...
2. Start backend: `cd backend && pip install -r requirements.txt && python run.py`
3. Open the web monitor: **http://127.0.0.1:8000/monitor** (M30 advisory cockpit)
4. Optional separate desk: **http://127.0.0.1:8000/dashboard** (M5 / M15 / H1 alignment playbook)
5. Allow `http://127.0.0.1:8000` in MT5 WebRequest settings.
6. Compile and attach the EA to your **Vantage XAUUSD M30** chart.
